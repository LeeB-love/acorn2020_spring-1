...
public class JSONTestController {
		...
		*/
		...
		/*
		* dto 타입을 알아서 json 형식으로 출력해준다.
		*/
		@RequestMapping("/json07")
		@ResponseBody
		public MemberDto json07() {
			MemberDto dto = new MemberDto(1, "이봉하", "강남구");
			return dto;
		}
